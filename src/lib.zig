...
pub const replay_metadata = @import("replay_metadata.zig");
...
pub const geometry = struct {
    ...
    pub const ArrayDuplicateOptions = @import("geometry/mesh_transform.zig").ArrayDuplicateOptions;
    pub const translateMesh = @import("geometry/mesh_transform.zig").translateMesh;
    pub const scaleMesh = @import("geometry/mesh_transform.zig").scaleMesh;
    pub const rotateMeshZ = @import("geometry/mesh_transform.zig").rotateMeshZ;
    pub const duplicateMeshArray = @import("geometry/mesh_transform.zig").duplicateMeshArray;
    ...
    pub const DeleteEdgeOptions = @import("geometry/mesh_delete_edge.zig").DeleteEdgeOptions;
    pub const deleteEdges = @import("geometry/mesh_delete_edge.zig").deleteEdges;
