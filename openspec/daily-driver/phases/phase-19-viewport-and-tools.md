# Phase 19: Viewport And Tools

## Intent

Add the first real interactive layer so a user can inspect and manipulate work
inside the application instead of only through exported files and CLI output.
